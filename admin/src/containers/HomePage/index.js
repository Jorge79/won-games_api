...
const SOCIAL_LINKS = [
  {
    name: "GitHub",
    link: "https://github.com/Jorge79/won-games_api",
  },
];
        ...
        <div className="row">
          <div className="col-lg-8 col-md-12">
            <Block>
              ...
              <P>
                Ao lado você pode inserir diferente jogos, categorias e
          ...
          <div className="col-md-12 col-lg-4">
            <Block style={{ paddingRight: 30, paddingBottom: 0 }}>
              <h2>Veja as nossas redes sociais</h2>
              <P style={{ marginTop: 7, marginBottom: 0 }}>
                Em caso de dúvidas e ou sugestões, só ir em um de nossos links
                :D
              </P>
              <ALink
